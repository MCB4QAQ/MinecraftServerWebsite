    ...
    <main class="lyear-layout-content">
      ...
      <div class="container-fluid">
        ...
        <div class="row">
          ...
          <div class="col-lg-12">
            <div class="card">
              <header class="card-header"><div class="card-title">网站主页日志</div></header>
              <div class="card-body">
                <?php
...
$sql = "SELECT id, ip, file, zhuangtai FROM indexlog";
$result = $conn->query($sql);
 
if ($result->num_rows > 0) {
    // 输出数据
    while($row = $result->fetch_assoc()) {
        echo "访问时间 " . $row["id"]. " - IP " . $row["ip"]. " - 访问路径 " . $row["file"]. " - 状态信息 " . $row["zhuangtai"]. "<br>";
    }
} else {
    echo "数据库字段为空！";
}
