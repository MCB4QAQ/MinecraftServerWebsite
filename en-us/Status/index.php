...
$host = "server.mcb4qaq.top"; //设置服务器域名或 IP
$port = "25565"; //设置服务器端口，可以直接用服务器的链接端口，也可以使用query端口（UDP协议）
$name = 'Cary World 1.18.2'; // 服务器名字，会显示在标签页的标题和网站打头的大标题处
...
$description = 'CaryWorld服务器监控<br>'; // 描述，会显示在大标题的下方，用html语法写就可以了，换行请用<br>
$imagelink = ''; // 图片链接，会显示在服务器信息右边的圈圈里
/*
$host = $_GET["host"];
$port = $_GET["port"];
							...
							<section id="intro" class="main">
								<div class="spotlight">
									<div class="content">
										...
										<p>域名：<font color="#2a6c0f"><?php echo $host; ?></font>
